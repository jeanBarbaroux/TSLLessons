...
import {uv, vec2, vec3, vec4, hash, rand, mx_noise_vec3, time, positionWorld, positionLocal, rotate} from 'three/tsl'
 ...
 */
{
    ...
    const material = new THREE.MeshStandardNodeMaterial({ map: textureColor, transparent: true })
 ...
 */
{
    ...
    const noise = mx_noise_vec3(positionWorld.add(time.mul(0.01)).mul(4))
